...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const partPages = partsData.map((p) => ({ url: `${base}/parts/${p.id}`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.6 }));
  return [
    { url: base, lastModified: now, changeFrequency: "daily", priority: 1.0 },
    { url: `${base}/tools`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/blog`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/parts`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    ...tools, ...articles, ...partPages,
  ];
}
